...

{
  ...
  programs.hyprpanel.settings = {
    "wallpaper.image" = "/home/david/nixos-config/wallpaper/rocman.png";
    "theme.matugen" = false;
    ...
    "menus.clock.weather.location" = "Salgótarján";
    ...
    "menus.dashboard.directories.left.directory3.label" = "󰚝  Development";
    "menus.dashboard.directories.right.directory1.label" = "󱧶  nixos-config";
    "menus.dashboard.directories.right.directory2.label" = "󰉏  Pictures";
    "menus.dashboard.directories.right.directory3.label" = "󱂵  Home";
    "menus.dashboard.directories.left.directory3.command" = "bash -c \"xdg-open $HOME/Development/\"";
    "menus.dashboard.directories.right.directory1.command" = "bash -c \"xdg-open $HOME/nixos-config/\"";
    "menus.dashboard.powermenu.avatar.image" = "/home/david/nixos-config/pfp.jpg";
  };
}
